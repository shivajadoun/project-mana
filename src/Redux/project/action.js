...
import { ACCEPT_INVITATION_SUCCESS, CREATE_PROJECT_REQUEST, CREATE_PROJECT_SUCCESS, DELETE_PROJECT_REQUEST, DELETE_PROJECT_SUCCESS, FETCH_PROJECT_BY_ID_FAILURE, FETCH_PROJECT_BY_ID_REQUEST, FETCH_PROJECT_BY_ID_SUCCESS, FETCH_PROJECT_REQUEST, FETCH_PROJECT_SUCCESS, INVITE_TO_PROJECT_SUCCESS, SEARCH_PROJECT_REQUEST, SEARCH_PROJECT_SUCCESS } from "./ActionTypes"
...
export const acceptInviteation=({inviationToken,navigate}) =>async (dispatch)=>{
    ...
    try{
        const{data}=await api.get("/api/projects/accept_invitation",{
            params:{token: inviationToken

            }
        })
        navigate("/project"+data.projectId)
        console.log("accept invition",data)
